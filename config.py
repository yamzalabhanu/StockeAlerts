...
AUTO_WATCHLIST_USE_SESSION_MOVERS = os.getenv("AUTO_WATCHLIST_USE_SESSION_MOVERS", "true").lower() == "true"
...
AUTO_WATCHLIST_SESSION_MOVER_LIMIT = int(os.getenv("AUTO_WATCHLIST_SESSION_MOVER_LIMIT", "80"))
...
REALTIME_STOCK_OVERLAY_SKIP_UNAUTHORIZED = os.getenv("REALTIME_STOCK_OVERLAY_SKIP_UNAUTHORIZED", "true").lower() == "true"
...
# Extended-hours bias improves early-session direction quality by scoring
# after-hours + pre-market price discovery before regular-session trends fully form.
EXTENDED_HOURS_BIAS_ENABLED = os.getenv("EXTENDED_HOURS_BIAS_ENABLED", "true").lower() == "true"
EXTENDED_HOURS_BIAS_WEIGHT = int(os.getenv("EXTENDED_HOURS_BIAS_WEIGHT", "12"))
EXTENDED_HOURS_CONFLICT_PENALTY = int(os.getenv("EXTENDED_HOURS_CONFLICT_PENALTY", "10"))
EXTENDED_HOURS_MIN_MOVE_PCT = float(os.getenv("EXTENDED_HOURS_MIN_MOVE_PCT", "0.35"))
EXTENDED_HOURS_MIN_VOLUME = int(os.getenv("EXTENDED_HOURS_MIN_VOLUME", "100000"))
...
OPENAI_SCAN_MODEL = os.getenv("OPENAI_SCAN_MODEL", "gpt-5-mini")
OPENAI_HIGH_QUALITY_MODEL = os.getenv("OPENAI_HIGH_QUALITY_MODEL", "gpt-5.2")
OPENAI_HIGH_QUALITY_MIN_SCORE = float(os.getenv("OPENAI_HIGH_QUALITY_MIN_SCORE", "95"))
OPENAI_REASONING_MODEL = os.getenv("OPENAI_REASONING_MODEL", OPENAI_SCAN_MODEL)
